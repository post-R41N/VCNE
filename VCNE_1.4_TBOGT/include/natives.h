...
extern void REQUEST_STREAMED_TXD(char *txdName);
...
extern boolean PRELOAD_STREAM(char *StreamName);
...
extern void DRAW_FRONTEND_HELPER_TEXT(char* gxtName, char* gxtName, boolean);
